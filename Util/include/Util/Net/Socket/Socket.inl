...
template<typename T>
Result<size_t, Socket::Error> Socket::ReadArray(T* data, size_t count) const requires ( std::is_fundamental_v<T> )
{
...
template<typename T>
Result<std::vector<T>, Socket::Error> Socket::ReadVector(size_t count) const requires ( std::is_fundamental_v<T> )
{
    std::vector<T> data;
    data.resize(count);
...
template<typename T>
Result<size_t, Socket::Error> Socket::WriteType(const T& data) const requires ( std::is_fundamental_v<T> )
{
...
template<typename T>
Result<size_t, Socket::Error> Socket::WriteArray(const T* data, size_t count) const requires ( std::is_fundamental_v<T> )
{
...
template<typename T>
Result<size_t, Socket::Error> Socket::WriteVector(const std::vector<T>& data) const requires ( std::is_fundamental_v<T> )
{
