...
{
    wxBEGIN_EVENT_TABLE(SoundEffectsPanel, wxPanel)
        EVT_BUTTON(PLAY_ONCE_BUTTON, SoundEffectsPanel::OnPlayOnceButton)
        EVT_BUTTON(PLAY_REPEAT_BUTTON, SoundEffectsPanel::OnPlayRepeatButton)
        EVT_BUTTON(ADD_SOUND_BUTTON, SoundEffectsPanel::OnAddSoundButton)
        EVT_BUTTON(REMOVE_SOUND_BUTTON, SoundEffectsPanel::OnRemoveSoundButton)
        EVT_BUTTON(RENAME_SOUND_BUTTON, SoundEffectsPanel::OnRenameSoundButton)
    wxEND_EVENT_TABLE()
}
